...
struct ContextObject {
    ...
    bool _isInputDirty_RS;
    bool _isInputDirty_EN;
    bool _isInputDirty_D4;
    bool _isInputDirty_D5;
    bool _isInputDirty_D6;
    bool _isInputDirty_D7;
    bool _isInputDirty_L1;
    bool _isInputDirty_L2;
};
...
template<> bool isInputDirty<input_RS>(Context ctx) {
    return ctx->_isInputDirty_RS;
}
template<> bool isInputDirty<input_EN>(Context ctx) {
    return ctx->_isInputDirty_EN;
}
template<> bool isInputDirty<input_D4>(Context ctx) {
    return ctx->_isInputDirty_D4;
}
template<> bool isInputDirty<input_D5>(Context ctx) {
    return ctx->_isInputDirty_D5;
}
template<> bool isInputDirty<input_D6>(Context ctx) {
    return ctx->_isInputDirty_D6;
}
template<> bool isInputDirty<input_D7>(Context ctx) {
    return ctx->_isInputDirty_D7;
}
template<> bool isInputDirty<input_L1>(Context ctx) {
    return ctx->_isInputDirty_L1;
}
template<> bool isInputDirty<input_L2>(Context ctx) {
    return ctx->_isInputDirty_L2;
}
...
template<> bool isInputDirty<input_IVAL>(Context ctx) {
    return ctx->_isInputDirty_IVAL;
}
...
template<> bool isInputDirty<input_STEP>(Context ctx) {
    return ctx->_isInputDirty_STEP;
}
...
struct ContextObject {
    ...
    bool _isInputDirty_LHS;
    bool _isInputDirty_RHS;
};
...
template<> bool isInputDirty<input_LHS>(Context ctx) {
    return ctx->_isInputDirty_LHS;
}
template<> bool isInputDirty<input_RHS>(Context ctx) {
    return ctx->_isInputDirty_RHS;
}
...
template<> void emitValue<output_GT>(Context ctx, Logic val) {
    ...
    ctx->_node->isOutputDirty_GT = true;
}
...
void runTransaction(bool firstRun) {
    ...
    { // xod__core__cast_boolean_to_pulse #0
        if (node_0.isNodeDirty) {
            ...
            ctxObj._isInputDirty_IN = node_17.isOutputDirty_OUT;
    ...
    { // xod__core__clock #12
        if (node_12.isNodeDirty) {
            ...
            ctxObj._isInputDirty_IVAL = firstRun;
    ...
    { // xod__core__count #13
        if (node_13.isNodeDirty) {
            ...
            ctxObj._isInputDirty_STEP = firstRun;
    ...
    { // xod__core__greater #14
        if (node_14.isNodeDirty) {
            ...
            ctxObj._isInputDirty_LHS = node_13.isOutputDirty_OUT;
            ctxObj._isInputDirty_RHS = firstRun;

            xod__core__greater::evaluate(&ctxObj);

            // mark downstream nodes dirty
            node_17.isNodeDirty |= node_14.isOutputDirty_GT;
        }
    }
    { // xod__core__cast_number_to_string #15
        if (node_15.isNodeDirty) {
            ...
            ctxObj._isInputDirty_IN = node_13.isOutputDirty_OUT;

            xod__core__cast_number_to_string::evaluate(&ctxObj);

            // mark downstream nodes dirty
            node_16.isNodeDirty |= node_15.isOutputDirty_OUT;
        }
    }
    { // xod__common_hardware__text_lcd_16x2 #16
        if (node_16.isNodeDirty) {
            ...
            ctxObj._isInputDirty_RS = firstRun;
            ctxObj._isInputDirty_EN = firstRun;
            ctxObj._isInputDirty_D4 = firstRun;
            ctxObj._isInputDirty_D5 = firstRun;
            ctxObj._isInputDirty_D6 = firstRun;
            ctxObj._isInputDirty_D7 = firstRun;
            ctxObj._isInputDirty_L1 = node_15.isOutputDirty_OUT;
            ctxObj._isInputDirty_L2 = firstRun;
    ...
    { // xod__core__defer_boolean #17
        if (node_17.isNodeDirty) {
            ...
            ctxObj._isInputDirty_IN = node_14.isOutputDirty_GT;
